...
[providers]
keychain = { type = "keychain", service = "option-like" }
pass = { type = "password-store", prefix = "option-like/" }
...
keywords = ["option", "newtype"]
categories = ["rust-patterns", "development-tools", "data-structures", "no-std", "no-std::no-alloc"]
exclude = [
    ".*",
    "*.local.*",
    "doc/dev",
